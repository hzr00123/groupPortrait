    ...
    setup (props) {
        ...
        function baseOption() {
            ...
            var option = {
                ...
                title: [
                    {
                        text: "{a|" + myStore.sumUpConfig["left"].regularity.rate + "%}", //主标题文本，支持使用 \n 换行。
                        textStyle: {  //主标题文字
                            // color: '#333',
                            // fontSize: 16,
                        ...
                        subtext: myStore.sumUpConfig["left"].regularity.value + '人',  //副标题文本
                        subtextStyle: {
                        color: '#3E5463',
                        fontSize: 14,
                        fontFamily: 'Regular'
                ...
                series: [
                    {
                        ...
                        data: [
                            {
                                name: '',
                                value: myStore.sumUpConfig["left"].regularity.rate,
                                itemStyle: {
                                normal: {
