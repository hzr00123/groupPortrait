        ...
        function baseOption() {
            ...
            var option = {
                ...
                xAxis: {
                    ...
                    data: myStore.gymnasiumConfig["right"].xAxis,
                    axisLine: {
                        show: true,
                        lineStyle: {
                ...
                series: [
                   {
                        ...
                        areaStyle: {
                            color: {
                                ...
                                y2: 1,
                                colorStops: [{
                                    offset: 0, color: 'rgba(0, 93, 167, 0.25)' // 0% 处的颜色
                                }, {
                                    offset: 1, color: 'rgba(0, 93, 167, 0)' // 100% 处的颜色
                                }],
                                global: false
                            }
                        },
                        data: myStore.gymnasiumConfig["right"].series,
                    },
                ],
            };
            return option;
