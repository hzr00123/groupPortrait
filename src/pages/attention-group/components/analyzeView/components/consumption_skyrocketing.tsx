...
const consumptionSkyrocketing = defineComponent({ name: 'consumptionSkyrocketing'})
...
consumptionSkyrocketing.leftView = leftView;
consumptionSkyrocketing.rightView = rightView;
export default consumptionSkyrocketing