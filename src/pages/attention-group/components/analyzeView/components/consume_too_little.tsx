...
const consumeTooLittle = defineComponent({ name: 'consumeTooLittle'})
...
consumeTooLittle.leftView = leftView;
consumeTooLittle.rightView = rightView;
export default consumeTooLittle