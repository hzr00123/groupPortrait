    ...
    props: {
        ...
        selectList: {
            ...
            default: () => [
                ...
                {
                    value: 'social_practice',
                    label: "社会实践"
                },
                {
                    value: 'Science_and_technology_innovation_activities',
                    label: "科创活动"
                },
                {
                    value: 'Extracurricular_training',
                    label: "课外培训"
                },
                {
                    value: 'Ideological_growth',
                    label: "思想成长"
                },
                {
                ...
                {
                    value: 'Cultural_and_sports_activities',
                    label: "文体活动"
                },
            ]
        }
        ...
        const colorConfig = reactive([
            {
                ...
                title: computed(()=>{
                    switch (isActive.value) {
                        ...
                        case 'Science_and_technology_innovation_activities':
                            return '科创活动';
                    
                        case 'Cultural_and_sports_activities':
                            return '文体活动';
                        default:
    ...
    setup(props, content) {
        ...
        const renderView = () => {
            ...
            function getLabel(str: string, pre: boolean){
                 switch (active.value) {
                    case 'overview2':
                        if(pre) return str + '第二课堂活动'
                        return '第二课堂活动' + str;
                
                    case 'Science_and_technology_innovation_activities':
                        if(pre) return str + '科创活动'
                        return '科创活动' + str;
                
                    case 'Cultural_and_sports_activities':
                        if(pre) return str + '文体活动'
                        return '文体活动' + str;
                    default:
...
Classroom.Left = LeftView
Classroom.Right = RightView
