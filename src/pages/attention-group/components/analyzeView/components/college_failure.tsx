...
const college_failure = defineComponent({name: "collegeFailure"})
...
const leftView = defineComponent({
    ...
    setup(props, content) {
        ...
        return () => {
            return <div class='college-failure-left' ref="leftCharts" style="height: 250px"></div>
        }
    }
})
...
const rightView = defineComponent({
    ...
    setup(props, content) {
        ...
        return () => {
            return <div class='college-failure-right' ref='WordCloud' style="height: 250px"></div>
        }
    }
})

college_failure.leftView = leftView;
college_failure.rightView = rightView;
export default college_failure