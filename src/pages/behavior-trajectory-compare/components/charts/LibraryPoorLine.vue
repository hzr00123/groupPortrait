        ...
        function baseOption() {
            ...
            var option = {
                ...
                xAxis: {
                    ...
                    data: myStore.libraryConfig["right"].xAxis,
                    axisLine: {
                        show: true,
                        lineStyle: {
                ...
                series: [
                   {
                        ...
                        areaStyle: {
                            color: {
                                ...
                                y2: 1,
                                colorStops: [{
                                    offset: 0, color: 'rgba(0, 201, 242, 0.36)' // 0% 处的颜色
                                }, {
                                    offset: 1, color: 'rgba(0, 201, 242, 0)' // 100% 处的颜色
                                }],
                                global: false
                            }
                        },
                        data: myStore.libraryConfig["right"].series[0].data,
                    },
                    {
                        name: '离馆人数',
                        type: 'line',
                        ...
                        areaStyle: {
                            ...
                            color: {
                                ...
                                y2: 1,
                                colorStops: [{
                                    offset: 0, color: 'rgba(255, 204, 0, 0.36)' // 0% 处的颜色
                                }, {
                                    offset: 1, color: 'rgba(255, 204, 0, 0)' // 100% 处的颜色
                                }],
                                global: false
                            }
                        },
                        ...
                        //         {offset: 0, color: 'rgba(0, 0, 255, 0.5)'}, // 渐变起始颜色
                        //         {offset: 1, color: 'rgba(0, 0, 255, 0)'}   // 渐变结束颜色
                        //     ])
                        // },
                        data: myStore.libraryConfig["right"].series[1].data,
                    }
                ],
            };
            return option;
