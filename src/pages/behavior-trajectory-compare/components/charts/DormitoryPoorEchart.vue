...
import {IChartRight} from "../../types/restraint"
    ...
    setup (props) {
        ...
        function baseOption() {
            var option = {
             ...
             myStore.dormitoryConfig["right"].forEach((m:any) => {
                option.series.push({
                    type: 'graph',
        ...
        return {
            myEchartsId,echartsMain,drawLine,baseOption,myChart,zhuanhuan
        }
    }
})
</script>
