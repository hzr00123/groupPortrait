...
const consumeTooMuch = defineComponent({ name: 'consumeTooMuch'})
...
consumeTooMuch.leftView = leftView;
consumeTooMuch.rightView = rightView;
export default consumeTooMuch